...
phonebook_threadpool: $(SRCS_common) phonebook_opt.c phonebook_opt.h threadpool.c threadpool.h text_align.c
	$(CC) $(CFLAGS_common) $(CFLAGS_threadpool) \
		-DIMPL="\"phonebook_opt.h\"" -DTHREADPOOL -o $@ \
